...
// KhulnasoftStarboardHelper :
type KhulnasoftStarboardHelper struct {
	Parameters StarboardParameters
}

func newKhulnasoftStarboardHelper(cr *khulnasoftv1alpha1.KhulnasoftStarboard) *KhulnasoftStarboardHelper {
	params := StarboardParameters{
		Starboard: cr,
	}

	return &KhulnasoftStarboardHelper{
		Parameters: params,
	}
}

func (enf *KhulnasoftStarboardHelper) CreateStarboardClusterRole(name string, namespace string) *rbacv1.ClusterRole {
...
func (enf *KhulnasoftStarboardHelper) CreateStarboardServiceAccount(cr, namespace, app, name string) *corev1.ServiceAccount {
	...
	annotations := map[string]string{
		"description": "Service account for khulnasoft starboard",
	}
...
func (enf *KhulnasoftStarboardHelper) CreateClusterRoleBinding(cr, namespace, name, app, sa, clusterrole string) *rbacv1.ClusterRoleBinding {
	...
	annotations := map[string]string{
		"description": "Deploy Khulnasoft starboard Cluster Role Binding",
	}
...
func (enf *KhulnasoftStarboardHelper) CreateStarboardConftestConfigMap(cr, namespace, name, app, version string) *corev1.ConfigMap {
	labels := map[string]string{
		"app":                        app,
		"deployedby":                 "khulnasoft-operator",
		"khulnasoftoperator_cr":      cr,
	...
	annotations := map[string]string{
		"description": "Deploy Khulnasoft starboard-policies-config ConfigMap",
	}
...
func (enf *KhulnasoftStarboardHelper) CreateStarboardConfigMap(cr, namespace, name, app string) *corev1.ConfigMap {
	...
	annotations := map[string]string{
		"description": "Deploy Khulnasoft starboard ConfigMap",
	}
	configMap := &corev1.ConfigMap{
		TypeMeta: metav1.TypeMeta{
			APIVersion: "v1",
...
func (enf *KhulnasoftStarboardHelper) CreateStarboardDeployment(cr *khulnasoftv1alpha1.KhulnasoftStarboard, name, app, registry, tag, pullPolicy, repository string) *appsv1.Deployment {
...
func (ebf *KhulnasoftStarboardHelper) getStarboardEnvVars(cr *khulnasoftv1alpha1.KhulnasoftStarboard) []corev1.EnvVar {
